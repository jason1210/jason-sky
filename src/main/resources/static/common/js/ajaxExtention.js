        ...
        $.ajax=function(opt){
            ...
            var _opt = $.extend(opt, {
                ...
                error: function (xhr,textStatus,errorThrown) {
                    if(xhr.status === 401){
                        // window.location.href = $tool.getResUrl()+"page/system/401.html";
                        return ;
                        ...
                        window.parent.parent.parent.parent.location.href = $tool.getResUrl()+"login.html";

                        return ;
                    }else if(xhr.status === 404){
                        // window.location.href = $tool.getResUrl()+"page/system/404.html";
                        return ;
                    }
